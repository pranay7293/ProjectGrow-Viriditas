...
Shader "Davis3D/AlienPlants_Vol3/Enviroment/Nebula"
{
	Properties
	{
		...
		[ASEBegin]_Contrast("Contrast", Float) = 0
		_Flowmap_Intensity("Flowmap_Intensity", Float) = 0.015
		_HueShift("HueShift", Float) = 0.01
		...
		[ASEEnd]_WaveTexture("WaveTexture", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 color5_g5 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 normalizeResult6_g5 = normalize( color5_g5 );
				...
				float3 temp_output_3_0_g5 = CalculateContrast(_Contrast,( _Color * tex2D( _Diffuse, lerpResult10 ) )).rgb;
				float3 rotatedValue2_g5 = RotateAroundAxis( temp_cast_1, temp_output_3_0_g5, normalizeResult6_g5.rgb, _HueShift );
				float3 temp_output_3_0 = ( rotatedValue2_g5 + temp_output_3_0_g5 );
				
				float3 hdEmission36 = ASEGetEmissionHDRColor(temp_output_3_0,temp_output_3_0.x,0.0,GetInverseCurrentExposureMultiplier());
				
				float2 uv_Diffuse = packedInput.ase_texcoord1.xy * _Diffuse_ST.xy + _Diffuse_ST.zw;
				
				surfaceDescription.Color = temp_output_3_0;
				surfaceDescription.Emission = hdEmission36;
				surfaceDescription.Alpha = tex2D( _Diffuse, uv_Diffuse ).a;
...
/*ASEBEGIN
Version=19108
Node;AmplifyShaderEditor.RangedFloatNode;24;-2339.05,310.6381;Inherit;False;Property;_Wave2_Speed;Wave2_Speed;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-2233.531,232.4609;Inherit;False;Property;_Wave2_Scale;Wave2_Scale;5;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-2241.752,43.69269;Inherit;False;Property;_Wave1_Scale;Wave1_Scale;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-2088.485,110.1895;Inherit;False;Property;_Wave1_Speed;Wave1_Speed;4;0;Create;True;0;0;0;False;0;False;0.7;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;16;-1750.568,182.6922;Inherit;True;Property;_TextureSample0;Texture Sample 0;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;15;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-1752.101,-5.772562;Inherit;True;Property;_WaveTexture;WaveTexture;9;0;Create;True;0;0;0;False;0;False;-1;abc00000000005186804306719253715;abc00000000005186804306719253715;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1300.582,152.0365;Inherit;False;Property;_Flowmap_Intensity;Flowmap_Intensity;1;0;Create;True;0;0;0;False;0;False;0.015;0.015;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;9;-897.808,-146.4889;Inherit;False;Property;_Color;Color;7;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-944.152,25.97462;Inherit;True;Property;_Diffuse;Diffuse;8;0;Create;True;0;0;0;False;0;False;-1;abc00000000006085887703447669439;abc00000000006085887703447669439;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-649.4023,75.7294;Inherit;False;Property;_Contrast;Contrast;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleContrastOpNode;27;-501.0792,23.65381;Inherit;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-470.0493,-49.2052;Inherit;False;Property;_HueShift;HueShift;2;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3;-311.0493,0.7947693;Inherit;False;HueShift;-1;;5;3748b6194161e1143a6905ade0b83f9a;0;2;1;FLOAT;0;False;3;FLOAT3;0,1,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;8;-294.4107,92.936;Inherit;True;Property;_TextureSample1;Texture Sample 1;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
