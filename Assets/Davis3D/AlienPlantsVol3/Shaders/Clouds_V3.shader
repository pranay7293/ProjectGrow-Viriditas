	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 blendOpDest3 = _Cloud_Color;
				float4 temp_output_3_0 = ( saturate( (( blendOpDest3 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest3 ) * ( 1.0 - blendOpSrc3 ) ) : ( 2.0 * blendOpDest3 * blendOpSrc3 ) ) ));
				...
				surfaceDescription.Emission = ( _Glow * temp_output_3_0 ).rgb;
...
Node;AmplifyShaderEditor.ColorNode;1;-615.142,-95.11369;Inherit;False;Property;_Cloud_Color;Cloud_Color;3;0;Create;True;0;0;0;False;0;False;1,0.5215687,0.5137255,1;1,0.5215687,0.5137255,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BlendOpsNode;3;-383.658,-22.61139;Inherit;False;Overlay;True;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-333.3319,-123.5442;Inherit;False;Property;_Glow;Glow;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;-194.9817,-78.01163;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;17;6;4;0
WireConnection;17;9;7;0
ASEEND*/
//CHKSM=89A6A36E20A48F6DA340D10CDC2114DA11071F75