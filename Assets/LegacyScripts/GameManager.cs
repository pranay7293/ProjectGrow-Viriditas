...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    {
        List<string> availableCharacters = new List<string>(CharacterSelectionManager.characterNames);
    ...
    private void SpawnCharacter(string characterName, bool isPlayerControlled, int spawnIndex)
    {
        ...
        GameObject characterGO = PhotonNetwork.Instantiate(characterPrefab.name, spawnPosition, Quaternion.identity);
